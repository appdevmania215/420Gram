...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [Parse setApplicationId:@"spWkH1V8ibmvLKLrX4pGmBvkdm2EEf1v98xHIm6D" clientKey:@"7pTMTi3KFTDKPyyzIpVxWnWqYzUShooKLRvCw5S8"];
...
//    [self.welcomeViewController presentModalViewController:loginViewController animated:NO];
    if ([self.welcomeViewController respondsToSelector:@selector(presentViewController:animated:completion:)]){
...
- (void)presentTabBarController {    
    ...
    UIImage *homeImage = [UIImage imageNamed:@"IconHome.png"];
    UIImage *homeImageSel = [UIImage imageNamed:@"IconHomeSelected.png"];
    ...
    UITabBarItem *homeTabBarItem = [[UITabBarItem alloc] initWithTitle:@"Home" image:homeImage selectedImage:homeImageSel];
    [homeTabBarItem setTitleTextAttributes: [NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"HelveticaLTStd-Roman" size:10.0f], NSFontAttributeName,  [UIColor colorWithRed:86.0f/255.0f green:55.0f/255.0f blue:42.0f/255.0f alpha:1.0f], NSForegroundColorAttributeName,nil] forState:UIControlStateNormal];
    [homeTabBarItem setTitleTextAttributes: [NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"HelveticaLTStd-Roman" size:10.0f], NSFontAttributeName,  [UIColor colorWithRed:129.0f/255.0f green:99.0f/255.0f blue:69.0f/255.0f alpha:1.0f], NSForegroundColorAttributeName,nil] forState:UIControlStateSelected];
    
    UIImage *activeImage = [UIImage imageNamed:@"IconTimeline.png"];
    UIImage *activeImageSel = [UIImage imageNamed:@"IconTimelineSelected.png"];
    
    activeImage = [activeImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    activeImageSel = [activeImageSel imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];

    UITabBarItem *activityFeedTabBarItem = [[UITabBarItem alloc] initWithTitle:@"Activity" image:activeImage selectedImage:activeImageSel];
    [activityFeedTabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"HelveticaLTStd-Roman" size:10.0f], NSFontAttributeName,  [UIColor colorWithRed:86.0f/255.0f green:55.0f/255.0f blue:42.0f/255.0f alpha:1.0f], NSForegroundColorAttributeName,nil] forState:UIControlStateNormal];
    [activityFeedTabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"HelveticaLTStd-Roman" size:10.0f], NSFontAttributeName,  [UIColor colorWithRed:129.0f/255.0f green:99.0f/255.0f blue:69.0f/255.0f alpha:1.0f], NSForegroundColorAttributeName,nil] forState:UIControlStateSelected];
...
//    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleBlackOpaque];
    ...
    [[UIBarButtonItem appearance] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys: [UIColor colorWithRed:214.0f/255.0f green:210.0f/255.0f blue:197.0f/255.0f alpha:1.0f], NSForegroundColorAttributeName, shadow, NSShadowAttributeName, [UIFont fontWithName:@"HelveticaNeue-CondensedBlack" size:21.0], NSFontAttributeName, nil] forState:UIControlStateNormal];
    ...
    if (data) {
        ...
        if (user) {
            if (![user objectForKey:kPAPUserAlreadyAutoFollowedFacebookFriendsKey]) {
                ...
                // find common Facebook friends already using 420Gram
                ...
                NSArray *gramFriends = [query findObjects:&error];
                
                if (!error) {
                    [gramFriends enumerateObjectsUsingBlock:^(PFUser *newFriend, NSUInteger idx, BOOL *stop) {
