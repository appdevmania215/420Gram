...
- (void)layoutSubviews {
	...
	CGSize labelSize = [label.text boundingRectWithSize: CGSizeMake(144, CGFLOAT_MAX) options: NSStringDrawingUsesLineFragmentOrigin attributes: @{ NSFontAttributeName: label.font } context: nil].size;
