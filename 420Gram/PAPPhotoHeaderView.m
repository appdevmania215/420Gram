...
- (id)initWithFrame:(CGRect)frame buttons:(PAPPhotoHeaderButtons)otherButtons {
    ...
    if (self) {
        ...
        if (self.buttons & PAPPhotoHeaderButtonsComment) {
            ...
            [self.commentButton setFrame:CGRectMake( 242.0f, 15.0f, 29.0f, 25.0f)];
        ...
        if (self.buttons & PAPPhotoHeaderButtonsLike) {
            ...
            [self.likeButton setFrame:CGRectMake(206.0f, 5.0f, 29.0f, 29.0f)];
            ...
            [self.likeButton setTitleEdgeInsets:UIEdgeInsetsMake(4.0f, 0.0f, 0.0f, 0.0f)];
...
- (void)setPhoto:(PFObject *)aPhoto {
    ...
    CGSize userButtonSize = [self.userButton.titleLabel.text boundingRectWithSize: constrainSize options: NSStringDrawingUsesLineFragmentOrigin attributes: @{ NSFontAttributeName: self.userButton.titleLabel.font } context: nil].size;
...
- (void)setLikeStatus:(BOOL)liked {
    ...
    if (liked) {
        [self.likeButton setTitleEdgeInsets:UIEdgeInsetsMake(10.0f, 5.0f, 0.0f, 0.0f)];
        [[self.likeButton titleLabel] setShadowOffset:CGSizeMake(0.0f, -1.0f)];
    } else {
        [self.likeButton setTitleEdgeInsets:UIEdgeInsetsMake(11.0f, 5.0f, 0.0f, 0.0f)];
        [[self.likeButton titleLabel] setShadowOffset:CGSizeMake(0.0f, 1.0f)];
    }
}
